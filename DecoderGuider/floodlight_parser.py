    ...
    def testOpenFlow(self,processed_list):
        ...
        try:
            for pkt in java_pkt_seq:
                javaClass = jpype.JClass("net.floodlight.openflowjtest.openflowj_test")
...
def fl_decoder_parsered_result(pcap_path,strategy_str):
    result = []
    ...
    result = test.testOpenFlow(processed_list)
    return result
