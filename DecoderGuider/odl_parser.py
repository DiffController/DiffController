    ...
    def testOpenFlow(self,processed_list):
        ...
        try:
            for pkt in java_pkt_seq:
                javaClass = jpype.JClass("org.opendaylight.odlopenflowtest.odl_openflowjava_test")
                javaInstance = javaClass()
                decoder_result = javaInstance.OpenFlowMsgDecoder(pkt)
                class_name = decoder_result.__class__.__name__.split(".")[-1]
...
def odl_decoder_parsered_result(pcap_path,strategy_str):
    result = []
